...
mongoose.connect("mongodb+srv://abhi_bank:bank@cluster0.tlozn.mongodb.net/Bankdb3", {
...
const defaultUserNames = ["Sneha", "Nidhi", "Bhavya", "Samar","Salokya", "Anish", "Arman", "Rupam", "Pradyut", "Abhishek"];
const defaultUsersEmail = ["sneha@gmail.com", "nidhi@gmail.com", "bhavya@gmail.com", "samar@gmail.com", "salokya@gmail.com", "anish@gmail.com", "arman@gmail.com", "rupam@gmail.com", "pradyut@gmail.com", "abhishek@gmail.com"];
const defaultUsersAddress = ["Bokaro, Jharkhand", "Ranchi, Jharkhand", "Durgapur, West Bengal", "Ranchi, Jharkhand", "Bhubaneswar, Odisha", "Anand Vihar, New Delhi"];

const defaultUsers = [];
for (let i = 0; i < defaultUserNames.length; i++) {
    if (defaultUserNames[i] === "Sneha" || defaultUserNames[i] === "Nidhi" || defaultUserNames[i] === "Bhavya" || defaultUserNames[i] === "Rupam") {
